...
import { 
  CheckCircle, XCircle, Clock, Palmtree, Calendar, FileText, Mic, 
  Image as ImageIcon, Upload, Play, Pause, RotateCcw, ChevronDown, 
  ChevronUp, Check, FlaskConical
} from "lucide-react";
            ...
            <div className="flex items-center gap-4 p-4 border rounded-xl">
              ...
              {todayStatus === "on_leave" && (
                <>
                  ...
                  <div>
                    <p className="font-semibold text-blue-600">On Leave</p>
        ...
        <Card className="bg-gradient-to-br from-orange-50 to-red-50 dark:from-orange-950/20 dark:to-red-950/20 border-orange-200/50 dark:border-orange-800/50">
          <CardContent className="pt-6">
            <div className="text-center">
              ...
              {streak === 0 && (
                <p className="text-xs text-orange-600/80 mt-2">Start your streak today!</p>
              )}
            </div>
          </CardContent>
        </Card>
